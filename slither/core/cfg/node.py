...
from slither.slithir.operations import (Balance, HighLevelCall, Index,
                                        ...
                                        LowLevelCall, Member, Transfer, Send, 
...
class Node(SourceMapping, ChildFunction):
    ...
    def __init__(self, node_type, node_id):
        ...
        self.callee = [] # for icfg
        self._sons = []
        self._fathers = []
        self._icfgSons = [] # for icfg
        self._icfgFathers = [] # for icfg
        
        self._backIcfgSons = [] # for icfg
        self._backIcfgFathers = [] # for icfg
    ...
    def can_send_eth(self):
        return self._can_send_eth(self.irs)
    ...
    def set_backIcfgSons(self, sons):
    ...
    def _find_read_write_call(self):
        ...
        for ir in self.irs:
            ...
            if isinstance(ir, SolidityCall):
                ...
                # self._internal_calls.append(ir.function) for icfg
            if isinstance(ir, LowLevelCall):
                ...
                # self._high_level_calls.append((ir.destination, ir.function)) for icfg
