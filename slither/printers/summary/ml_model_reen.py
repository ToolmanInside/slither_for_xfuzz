...
class ModelPredictionReen(AbstractPrinter):
    """
    Predictor Based On Machine Learning Models
    """

    ARGUMENT = 'model-prediction-reen'
    ...
    def __init__(self, slither, logger):
        super(ModelPredictionReen, self).__init__(slither, logger)
...
class MLModelReen(object):
    def __init__(self):
        self._model = self._load_trained_model()

    def _load_trained_model(self):
        url = "https://drive.google.com/uc?id=177D2axnEkbRFazuopsll9PdBzzSs_hnO"
